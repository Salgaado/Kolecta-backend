...
const devUsers = [
  { id: 'seller-001', email: 'vendedor@email.com', name: 'Coleção Turbo', role: 'user' },
  { id: 'buyer-001', email: 'joao@email.com', name: 'João Silva', role: 'user' },
  { id: 'admin-001', email: 'admin@kolecta.com.br', name: 'Admin Kolecta', role: 'admin' },
];

const mockCategories = [
  { id: 'c1', name: 'Carrinhos & Miniaturas', slug: 'carrinhos-miniaturas', icon: '🏎️' },
  { id: 'c2', name: 'Funko Pop', slug: 'funko-pop', icon: '🎭' },
  { id: 'c3', name: 'Cards Colecionáveis', slug: 'cards-colecionaveis', icon: '🃏' },
